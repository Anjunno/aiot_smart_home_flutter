  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<ThemeColor>(
      builder: (context, themeColor, child) {
        // 테마 색상 설정
        Color barColor = themeColor.isDark ? Colors.blue : Colors.green;
            ...
            BarChartData(
              ...
              gridData: FlGridData(
                ...
                getDrawingHorizontalLine: (value) {
                  return FlLine(
                    color: gridColor, // 수평선의 색상을 테마에 맞게 설정
                ...
                leftTitles: AxisTitles(
                  sideTitles: SideTitles(
                    ...
                    getTitlesWidget: (value, meta) {
                      ...
                      return Text('${value.toStringAsFixed(0)} kWh',
              ...
              borderData: FlBorderData(
                ...
                border: Border.all(
                  color: themeColor.isDark ? Colors.white : Color(0xff37434d), // 테두리 색상
                  width: 1, // 테두리 두께 설정
                ),
              ),
              // minX: 0, // X축 최소값
                ...
                return BarChartGroupData(
                  ...
                  barRods: [
                    BarChartRodData(
                      toY: energy,
                      width: 30,
                      color: barColor, // 막대 색상 테마에 맞게 설정
